...
# Use the fixed timestamp from the previous interrupted backup
readonly DATETIME="2025-04-11_10:24:39"
...
echo "[$(date '+%Y-%m-%d %H:%M:%S')] Backing up continue..." | tee -a "${LOG_FILE}"
